...
# MCP server is now defined above, right after the crawl4ai_lifespan function
...
# La fonction extract_section_info a été déplacée dans knowledge_graphs.utils
...
# La fonction process_code_example a été déplacée vers knowledge_graphs.utils
...
async def main():
    ...
    try:
        ...
        print(f"  Health Port: 8052")
        print(f"  Debug: {DEBUG}")
        print(f"  Use Reranking: {USE_RERANKING}")
        print(f"  Use Knowledge Graph: {USE_KNOWLEDGE_GRAPH}")
        print("-" * 80)
